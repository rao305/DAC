# DAC Frontend Components Documentation

## Overview

This document provides a comprehensive guide to all new UI components built for the DAC (Data Analysis Copilot) conversation interface. All components follow the existing design system with dark theme and violet/purple accents.
