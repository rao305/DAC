...
const faqItems = [
  {
    ...
    answer:
      "DAC is an enterprise-grade platform for deploying and managing autonomous AI agents at scale. It provides security, monitoring, compliance controls, and seamless integration with your existing tools.",
  },
  {
    question: "How is DAC different from other AI agent platforms?",
    answer:
      "DAC is built specifically for enterprise deployments with built-in security, compliance, and observability. We handle infrastructure complexity so you can focus on your agents' logic and outcomes.",
  },
  {
  ...
  {
    question: "Is my data secure on DAC?",
    answer:
      "Yes. DAC includes end-to-end encryption, audit trails, role-based access controls, and compliance certifications (SOC 2, HIPAA, GDPR ready). Security is built into every layer.",
  },
  {
    ...
    <section className="py-20 md:py-32 border-t border-border">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-muted-foreground">Everything you need to know about DAC</p>
        </div>
