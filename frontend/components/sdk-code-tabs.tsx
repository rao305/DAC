...
const codeExamples = {
  typescript: `import { DAC } from '@dac/sdk'

const client = new DAC({
  apiKey: process.env.DAC_API_KEY
})
...
for await (const chunk of response) {
  ...
  python: `from dac import DAC

client = DAC(
    api_key=os.environ.get("DAC_API_KEY")
)
...
for chunk in response:
  ...
  curl: `curl https://api.dac.io/v1/chat/completions \\
  -H "Authorization: Bearer $DAC_API_KEY" \\
