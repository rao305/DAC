...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! DAC lets you bring your own API keys for OpenAI, Anthropic, Google, and other providers. We handle routing and fallbacks while you maintain full cost control.",
  },
]
