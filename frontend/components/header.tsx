            ...
            {user && (
              <>
                ...
                <Link href="/conversations" className="flex items-center">
                  <div className="w-9 h-9 rounded-full border border-[#1f2937] overflow-hidden bg-[#0f172a]">
                    ...
                    {(!user.photoURL || avatarError) && (
                      <div className="w-full h-full bg-emerald-500/20 flex items-center justify-center text-emerald-300 text-sm">
