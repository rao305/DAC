      ...
      <div className={cn("h-14 flex items-center px-3", isCollapsed ? "justify-center" : "justify-between")}>
        {!isCollapsed && (
          <div className="flex items-center gap-2 px-2 py-1 rounded-md hover:bg-zinc-900 cursor-pointer transition-colors group">
            ...
            <span className="font-semibold text-zinc-200">Okara</span>
          </div>
        )}
        <Button
          variant="ghost"
          ...
          {!isCollapsed && (
            <>
              <div className="flex-1 overflow-hidden text-left">
                <p className="text-sm font-medium text-zinc-200 truncate">Guest</p>
                <p className="text-xs text-zinc-500 truncate">Sign In</p>
              </div>
